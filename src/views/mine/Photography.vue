...
export default {
  data() {
    return {
      ...
      phone: 'phone',
 images :
  [{'name':require('@/assets/gallery/IMG_4370.jpg'),
    'alt':'trees',
    'id':'image1' },

   {'name':require('@/assets/gallery/IMG_4390.jpg'),
    'alt':'driftwood',
    'filter':'wood',
    'id':'image2'  },

   {'name':require('@/assets/gallery/IMG_4410.jpg'),
    'alt':'seagull',
    'filter':'bird',
    'id':'image3'  },

   {'name':require('@/assets/gallery/IMG_4450.jpg'),
    'alt':'splash',
    'filter':'water',
    'id':'image4'  },

   {'name':require('@/assets/gallery/IMG_5956.jpg'),
    'alt':'another gull',
    'filter':'bird',
    'id':'image5'  },

   {'name':require('@/assets/gallery/IMG_5989.jpg'),
    'alt':'eye',
    'filter':'wood',
    'id':'image6'  },

   {'name':require('@/assets/gallery/IMG_5992.jpg'),
    'alt':'close-up',
    'filter':'wood',
    'id':'image7'  },

   {'name':require('@/assets/gallery/IMG_6149.jpg'),
    'alt':'heron-cleaning',
    'filter':'bird',
    'id':'image8'  },

    {'name':require('@/assets/gallery/IMG_6166.jpg'),
    'alt':'heron',
    'filter':'bird',
    'id':'image9' },

   {'name':require('@/assets/gallery/IMG_6184.jpg'),
    'alt':'drip1',
    'filter':'water',
    'id':'image10'  },

   {'name':require('@/assets/gallery/IMG_5603.jpg'),
    'alt':'little',
    'filter':'bird',
    'id':'image11'  },

   {'name':require('@/assets/gallery/IMG_6191.jpg'),
    'alt':'splash',
    'filter':'water',
    'id':'image12'  },

   {'name':require('@/assets/gallery/IMG_6239.jpg'),
    'alt':'flight',
    'filter':'bird',
    'id':'image13'  },

   {'name':require('@/assets/gallery/IMG_6244.jpg'),
    'alt':'flight2',
    'filter':'bird',
    'id':'image14'  },
