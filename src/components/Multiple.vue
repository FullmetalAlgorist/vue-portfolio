  ...
  <div>
          <v-carousel :cycle="false" hide-delimiters>
            <div v-for="item in grammy" :key="item.id">
                 <div class="portfolio-box-caption" v-if="dialog"> <v-icon
          ...
          @click="dialog = !dialog"
           ...
           class="infomer close"
          >mdi-close</v-icon>
          <div class="inards text-xs-center align-center">
              {{cap | firstLine }}
          </div>
          ...
          >mdi-information</v-icon>
                  <video  :controls="hov ? true : false" controlsList="nodownload" loop>
